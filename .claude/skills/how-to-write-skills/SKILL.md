...
description: Comprehensive guide for creating effective Claude Code Skills. Use when writing new skills, restructuring existing skills, or understanding skill patterns and best practices.
---

# How to Write Claude Code Skills

Master the art of creating effective, discoverable, and well-structured Claude Code Skills that enhance AI capabilities for your projects.
...
That's it! Claude Code will automatically discover and use your skill.
...
**Official Note**: Claude discovers supporting files through links in SKILL.md. Files are loaded only when referenced.
...
- `description` must answer two questions: (1) What does it do? (2) When should Claude use it?
...
- **Global skills**: `~/.claude/skills/` (fully supported in 2025)
...
| Task | Command/Action |
|------|----------------|
| Create skill | `mkdir -p .claude/skills/my-skill` |
| Test discovery | Ask "What skills are available?" |
| Test triggering | Ask task matching description |
| Check size | `wc -l .claude/skills/my-skill/SKILL.md` |
...
3. **Location matters**: Use `.claude/skills/` for project skills
