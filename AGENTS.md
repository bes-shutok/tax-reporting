...
- When a `docs/tax/decision_points/<year>.md` entry enumerates a rule as N-tier/N-case, verify the enumeration (count and cases) matches the implemented code branches; update the prose when a branch is added or changed. See `development_lessons.md` #123.
