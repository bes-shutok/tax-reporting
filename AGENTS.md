...
- A test fixture binding a named local from a positional CSV field must put the value at the column index the production reader extracts; a wrong comma count leaves it at its default while green hides it. See `development_lessons.md` #59, #60.
