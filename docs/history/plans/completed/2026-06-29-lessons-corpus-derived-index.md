...
- `docs/history/feature-notes/completed/<run-date>-principle-index-audit-snapshot.md` *(new)* - frozen audit snapshot emitted by the migration skill (run-date stamped; r2 Low 1).
...
- **Emit the frozen audit snapshot** `docs/history/feature-notes/completed/<date>-principle-index-audit-snapshot.md` (banner: FROZEN ONE-TIME AUDIT; verbatim `## Blind-spot analysis`, `## Dry-run recall`, `## Precision gate`, `## Duplicate clusters`, `## Accounting check` from the deleted index).
...
- `docs/history/feature-notes/completed/<run-date>-principle-index-audit-snapshot.md` *(new, written by the skill's snapshot step; `<run-date>` resolves to the migration run date, NOT the historical 2026-06-21 audit date - r2 Low 1)*
