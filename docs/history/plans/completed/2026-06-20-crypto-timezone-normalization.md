...
Related RFC: `docs/history/feature-notes/completed/2026-06-20-th-anchored-transaction-state-machine.md` (weakness #3). Decision point: DP-014 (payment-proceeds correction). Review context: `docs/history/reviews/2026-06-20-branch-review-doc-hierarchy-migration.md`.
...
- [x] `docs/history/feature-notes/completed/2026-06-20-th-anchored-transaction-state-machine.md` weakness #3 - mark the timezone issue as addressed by this plan (reference the plan path); leave the multi-lot OGR item as still-open.
