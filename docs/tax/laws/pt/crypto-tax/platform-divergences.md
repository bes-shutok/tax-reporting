...
19 loan repayment transactions across SUI (10), WBTC (5), LBTC (4). Total phantom gain/loss impact: approximately -6,120 EUR. For the repeatable audit methodology, see `docs/domain/loan_repayment_audit_methodology.md`.
