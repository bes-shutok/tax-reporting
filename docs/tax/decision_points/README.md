...
2. Open the current consolidated CIRS PDF (`docs/tax/laws/pt/crypto-tax/official/cirs_2025-07_code_consolidated.pdf`) and locate the same provision by searching for the legal text — not by paragraph number alone.
