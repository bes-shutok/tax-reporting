...
## Capital gains
- File: `koinly_2025_capital_gains_report_<ACCOUNT_TOKEN>.csv`
- Header: `Date Sold,Date Acquired,Asset,Amount,Cost (EUR),Proceeds (EUR),Gain / loss,Notes,Wallet Name,Holding period`

## Income (rewards)
- File: `koinly_2025_income_report_<ACCOUNT_TOKEN>.csv`
- Header: `Date,Asset,Amount,Value (EUR),Type,Description,Wallet Name`

## Beginning holdings
- File: `koinly_2025_beginning_of_year_holdings_report_<ACCOUNT_TOKEN>.csv`
- Header: `Asset,Quantity,Cost (EUR),Value (EUR),Description`

## End holdings
- File: `koinly_2025_end_of_year_holdings_report_<ACCOUNT_TOKEN>.csv`
- Header: `Asset,Quantity,Cost (EUR),Value (EUR),Description`

## Transaction history (fallback/reconciliation)
- File: `koinly_2025_transaction_history_<ACCOUNT_TOKEN>.csv`
