...
For the legal basis (why loan repayment is not taxable under Portuguese law) and Koinly-specific behaviors, see `docs/maintenance/tax/laws/pt/crypto-tax/platform-divergences.md` Section 1.
...
2. **Koinly fix**: Apply the "change worth" workaround (see `docs/maintenance/tax/laws/pt/crypto-tax/platform-divergences.md` Option A) to neutralize phantom gains in Koinly itself
