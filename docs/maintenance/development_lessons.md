...
## 182. Jurisdiction-Specific Tax Output Must Be Flag-Gated, Never Fire Unconditionally
...
## 195. A Predicate That Compares to the Same Hardcoded Literal That Gates Entry to Its Branch Is Structurally Untestable for the Case That Would Expose Its Error
...
## 196. A Test Deferred in Task N as Out-of-Scope Becomes Stale in Task N+1 When N+1 Changes the Contract the Test's Premise Rests On
...
## 197. A Wording-Pass Review Must Grep Method IDENTIFIERS, Not Only Docstrings and Rendered Messages
